...
this.tabla.setModel(modelo);
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOMBRE", "APELLIDO", "CIUDAD", "EDAD", "SEXO", "PLACA"
            }
        ));
        ...
        jPanel1.add(PLACA, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 180, 190, -1));
    ...
    private void GUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GUARDARActionPerformed
        ...
        if (nombre.isEmpty() || apellido.isEmpty() || ciudad.isEmpty() || placa.isEmpty()) {
        ...
        if (edadNumero < 18 || edadNumero>100) {
            // Mostrar un mensaje de error si la edad es menor o igual a 18
            JOptionPane.showMessageDialog(this, "La edad debe ser mayor o igual a 18 y menor a 100.", "Error", JOptionPane.ERROR_MESSAGE);
            return; // Salir del método sin guardar los datos
        }
        
        // Crear una cadena con los datos a guardar
        String datos = nombre + "," + apellido + "," + ciudad + "," + edad + "," + sexo +","+placa;
